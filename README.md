# Ecosistema Institucional Seguro (Cathering + Foodies)

Bienvenido al repositorio central del proyecto integrador. Este monorepo contiene la infraestructura global, los microservicios y las aplicaciones frontend de la arquitectura.

## 📂 Estructura del Repositorio

* **`/Cathering3`**: Código fuente del Sistema A (Backends en Node.js, Frontend en React, API Gateway, bases de datos SQLite e integraciones criptográficas).
* **`/docs`**: Documentación oficial y contratos de diseño de la arquitectura.
